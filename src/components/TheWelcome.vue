...
<template>
  ...
  <WelcomeItem>
    ...
    This project is served and bundled with <<<<<<< HEAD
    ...
    <a href="https://code.visualstudio.com/" target="_blank">VSCode</a> +
    <a href="https://github.com/johnsoncodehk/volar" target="_blank">Volar</a>.
    If you need to test your components and web pages, check out >>>>>>> ae17bde
    (Pare down)
  ...
  <WelcomeItem>
    ...
    Got stuck? Ask your question on <<<<<<< HEAD
    ...
    >. You should also subscribe to
    <a target="_blank" href="https://news.vuejs.org">our mailing list</a> and
    follow the official >>>>>>> ae17bde (Pare down)
  ...
  <WelcomeItem>
    ...
    <<<<<<< HEAD As an independent project, Vue relies on community backing for
    its sustainability. You can help us by ======= As an independent project,
    Vue relies on community backing for its sustainability. You can help us by
    >>>>>>> ae17bde (Pare down)
